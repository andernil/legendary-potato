...
void setupGPIO()
{
    ...
    *GPIO_PC_DOUT = 0xFF;    /*Enable internal pullups for the input pins*/
    ...
    *GPIO_EXTIFALL = *GPIO_EXTIRISE = *GPIO_IEN = 0xFF; /* Write 0xFF to enable interrupts, and enable interrupts on positive and negative slope */
	/*
